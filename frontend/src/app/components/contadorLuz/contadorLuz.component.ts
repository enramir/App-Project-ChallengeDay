...
@Component({
  selector: 'app-contadorLuz',
  templateUrl: './contadorLuz.component.html',
  styleUrls: ['./contadorLuz.component.css'],
  providers: [DeviceService]

})
export class ContadorLuzComponent implements OnInit {
